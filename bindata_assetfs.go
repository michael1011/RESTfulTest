...
var _buildTxt = []byte("\x1f\x8b\x08\x00\x00\x09\x6e\x88\x00\xff\x4a\x49\x2d\xe3\x02\x04\x00\x00\xff\xff\xed\x81\xac\x42\x04\x00\x00\x00")
...
func buildTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "build.txt", size: 4, mode: os.FileMode(420), modTime: time.Unix(1476358434, 0)}
